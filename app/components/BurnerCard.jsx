  ...
  return (
    <div className='max-w-[300px] min-w-[300px] flex flex-col gap-2 p-4 shadow-md'>
        <div className='flex items-center justify-between'>
            ...
            <IoFlameSharp size={60} className='p-4 rounded-full bg-orange-50 fill-orange-300' />     
        </div>
        ...
        <div className='w-full relative h-[10px] bg-rose-500 rounded-lg'>
            <div className='absolute bg-green-500 w-[40%] h-full rounded-lg '></div>
        </div>
